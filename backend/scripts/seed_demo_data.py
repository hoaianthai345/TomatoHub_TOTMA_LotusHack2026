    ...
    try:
        ...
        campaigns_data = [
            ...
            },
            {
                ...
                "organization_id": organizations[0].id,
                "description": "Distribute cooling kits, water stations and night-shift meal boxes.",
                "short_description": "Cooling support and hydration points for outdoor workers in Binh Thanh.",
                "tags": ["heat", "workers", "community"],
                "cover_image_url": "https://images.unsplash.com/photo-1491438590914-bc09fcaaf77a?w=1200&q=80",
                "goal_amount": Decimal("18000.00"),
                "raised_amount": Decimal("6200.00"),
                "support_types": [SupportType.money.value, SupportType.volunteer.value],
                "province": "Ho Chi Minh City",
                "district": "Binh Thanh",
                "address_line": "Worker Support Hub, Ward 22",
                "media_urls": [
                    "https://images.example.org/campaigns/heat-relief-cover.jpg",
                ],
                "starts_at": now + timedelta(days=2),
                "ends_at": now + timedelta(days=42),
                "is_active": True,
                "status": CampaignStatus.published,
            ...
            },
            {
                ...
                "organization_id": organizations[0].id,
                "description": "Prepare a draft logistics campaign for weekend neighborhood deliveries.",
                "short_description": "Draft campaign to organize delivery staging, packing, and volunteer routing.",
                "tags": ["logistics", "draft", "community"],
                ...
                "support_types": [SupportType.volunteer.value, SupportType.goods.value],
                "province": "Ho Chi Minh City",
                "district": "Thu Duc",
                "address_line": "Shared Community Warehouse",
                "media_urls": [
                    "https://images.example.org/campaigns/weekend-logistics-draft.jpg",
                ],
                "starts_at": now + timedelta(days=10),
                "ends_at": now + timedelta(days=55),
                "is_active": False,
        ...
        beneficiary_data = [
            ...
            },
            {
                ...
                "story": "Needs cooling supplies and transport support after multiple heatstroke incidents.",
        ...
        donation_data = [
            ...
            {
                "campaign_id": campaigns[0].id,
                "donor_user_id": users_by_email["pham.lananh@example.com"].id,
                "donor_name": "Pham Lan Anh",
                "amount": Decimal("1200.00"),
                "currency": "VND",
                "payment_method": "credit_card",
                "note": "School term support",
                "donated_at": now - timedelta(days=2, hours=6),
            },
            {
                "campaign_id": campaigns[0].id,
                "donor_user_id": None,
                ...
                "currency": "VND",
                "payment_method": "e_wallet",
                "note": "Books and digital kits",
                "donated_at": now - timedelta(days=1, hours=12),
            },
            {
                "campaign_id": campaigns[1].id,
                "donor_user_id": users_by_email["pham.lananh@example.com"].id,
                ...
                "currency": "VND",
                "payment_method": "bank_transfer",
                "note": "For aftercare medicines",
                "donated_at": now - timedelta(days=1, hours=18),
            },
            {
                "campaign_id": campaigns[1].id,
                "donor_user_id": None,
                ...
                "currency": "VND",
                "payment_method": "bank_transfer",
                "note": "Hospital partnership support",
                "donated_at": now - timedelta(hours=30),
            },
            {
                "campaign_id": campaigns[1].id,
                "donor_user_id": None,
                ...
                "currency": "VND",
                "payment_method": "credit_card",
                "note": "Critical treatment top-up",
                "donated_at": now - timedelta(hours=12),
            },
            {
                "campaign_id": campaigns[2].id,
                "donor_user_id": users_by_email["pham.lananh@example.com"].id,
                ...
                "donated_at": now - timedelta(days=2, hours=3),
            },
            {
                "campaign_id": campaigns[2].id,
                "donor_user_id": None,
                ...
                "currency": "VND",
                "payment_method": "bank_transfer",
                "note": "Bulk food support",
                "donated_at": now - timedelta(days=1, hours=8),
            },
            {
                "campaign_id": campaigns[2].id,
                "donor_user_id": None,
                ...
                "currency": "VND",
                "payment_method": "bank_transfer",
                "note": "Temporary shelter reinforcement",
                "donated_at": now - timedelta(hours=20),
            },
            {
                "campaign_id": campaigns[3].id,
                "donor_user_id": users_by_email["mai.giang@example.com"].id,
                ...
                "currency": "VND",
                "payment_method": "e_wallet",
                "note": "Water station kickoff",
                "donated_at": now - timedelta(hours=16),
            },
            {
                "campaign_id": campaigns[3].id,
                "donor_user_id": users_by_email["nguyen.tuan@example.com"].id,
                ...
                "currency": "VND",
                "payment_method": "bank_transfer",
                "note": "Cooling kit support",
                "donated_at": now - timedelta(hours=10),
            },
            {
                "campaign_id": campaigns[3].id,
                "donor_user_id": None,
                ...
                "donated_at": now - timedelta(hours=8),
            },
            {
                "campaign_id": campaigns[3].id,
                "donor_user_id": None,
                ...
                "currency": "VND",
                "payment_method": "credit_card",
                "note": "Heat relief supplies",
                "donated_at": now - timedelta(hours=5),
            },
        ]
        ...
        volunteer_data = [
            ...
            },
            {
                ...
                "email": "mai.giang@example.com",
                "phone_number": "+84-900-000-001",
                "message": "Can help manage hydration checkpoints before sunrise.",
                "status": VolunteerStatus.approved,
            },
            {
                "campaign_id": campaigns[0].id,
                "user_id": users_by_email["tran.quocminh@example.com"].id,
                "full_name": "Tran Quoc Minh",
                "email": "tran.quocminh@example.com",
                "phone_number": "+84-900-000-004",
                "message": "Ready to support classroom delivery and packing.",
                "status": VolunteerStatus.approved,
            },
            {
                "campaign_id": campaigns[3].id,
                "user_id": users_by_email["pham.lananh@example.com"].id,
                "full_name": "Pham Lan Anh",
                "email": "pham.lananh@example.com",
                "phone_number": "+84-900-000-005",
                "message": "Can help with worker interviews and supply distribution.",
                "status": VolunteerStatus.pending,
            },
            {
                "campaign_id": campaigns[1].id,
                ...
                "email": "tran.quocminh@example.com",
                "phone_number": "+84-900-000-004",
                "message": "Medical logistics and patient transport support.",
                "status": VolunteerStatus.approved,
            },
            {
                "campaign_id": campaigns[1].id,
            ...
            },
            {
                ...
                "message": "Available for evening support shifts.",
                "status": VolunteerStatus.pending,
            },
        ]
